...
![A photo shows a child with Hutchinson-Gilford progeria syndrome. The child has a large, bald head, and is holding a brightly colored toy.](images/01.png)
...
![A photo shows genetically engineered corn with large kernels.](images/02.png)
...
![An illustration shows the method of D N A fingerprinting. The question in this experiment is: How can we identify people based on differences in their D N A?](images/20.png)
...
![A photo shows a woman performing D N A fingerprinting in a laboratory.](images/23.png)
...
![A photo shows a black skinny mouse next to a black obese mouse.](images/26.png)
...
![An illustration shows an expression plasmid that has complementary s-i-R N A sense strand with ends labeled 3-prime and 5-prime and antisense strands with ends labeled 5-prime and 3-prime. The two strands are located between two promoters and lead to the formation of a double-stranded R N A.](images/30.png)
...
![A photo shows a woman wearing a face mask and gloves as she operates a pipette. A desk with equipment, including tubes in trays, is in front of her.](images/31.png)
